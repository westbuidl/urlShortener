                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:570px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                                <tr>
                                    <td style="height:100px; width : 100%; background-color:#1d988c">
                                        ...
                                        <img src="https://agroease.trade/assets/img/agroease1%202.png" style="height: 80px; margin-right: 340px; margin-bottom: 0px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <br>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding:0 35px; ">
                                        ...
                                        <h1 style="color:#1a1a1a; font-weight:510; margin-top:10px;font-size:15px;font-family:'Gilroy',sans-serif;text-align:justify; line-height:22px; letter-spacing: normal; ">We've received a request to reset the password for your <strong>Agroease</strong> account. To proceed with the password reset, simply click the button below to verify your request:</h1><br>
                                        <h1 style="background-color:#7e66ef; cursor:pointer; border-radius: 100px; height: 55px; padding:17px, 141px, 17px, 141px; margin-top:10px;"><span style="font-weight:600; color:#fff; font-size:16px;">{{$reset_password}}</span></h1><br>
                                        <h1 style="color:#1a1a1a; font-weight:500; margin-top:2px;font-size:15px;font-family:'Gilroy',sans-serif;text-align:justify; line-height:22px"><strong>Didn't request a password reset?</strong> <br><br> If you didn't initiate this password reset request, you can safely ignore this email. Your account remains secure. <br><br>If you encounter any difficulties
                                            or have any questions, don't hesitate to reach out to our support team at <a href="mailto:support@agroease.ng" style="color: #1d988c; text-decoration: none;"><strong>support@agroease.ng</strong></a>
                                            <br><br>Thank you for your attention to this matter.<br><br>Best regards, <br><br>The Agroease Team</h1><br>
                                    </td>
                                </tr>
                                <tr>
