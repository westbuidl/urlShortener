                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:570px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:0 35px; ">
                                        ...
                                        <h1 style="color:#1a1a1a; font-weight:530; margin-top:10px;font-size:18px;font-family:'Gilroy',sans-serif;text-align:justify; line-height:22px; letter-spacing: normal; ">We have received a request to withdraw funds from your wallet. For your security, please verify this transaction using the One-Time Password (OTP) provided below valid for 10 minutes. </h1><br>
                                        ...
                                        <h1 style="background-color:#91E0E8; border-radius: 16px; font-weight:700; margin-top:10px;font-size:16px;font-family:'Gilroy', sans-serif;text-align:center ; line-height:2"><span style="font-weight:700; color:#1a1a1a; font-size:30px;">{{$otp}}</span> </h1><br>
                                        <h1 style="color:#1a1a1a; font-weight:500; margin-top:2px;font-size:15px;font-family:'Gilroy',sans-serif;text-align:justify; line-height:22px">To complete the withdrawal, please enter this OTP on the confirmation screen within the next 10 minutes. For security reasons, the OTP will expire after this time.<br><br><br>
                                            If you did not initiate this withdrawal, please contact our support team immediately at <a href="mailto:contact@agroease.com"
