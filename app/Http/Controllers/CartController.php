    ...
    private function createOrder($paymentData, $buyerId, $shippingFee)
    {
        ...
        foreach ($cartItems as $cartItem) {
            ...
            $order = new Order([
                ...
                'amount' => $cartItem->selling_price,
                'quantity' => $cartItem->quantity,
                'paymentMethod' => $paymentData['channel'],
                'paymentReference' => $paymentData['reference'],
                'shippingFee' => $shippingFee,
                'order_status' => $paymentData['status'],
                'currency' => $paymentData['currency'],
                'channel' => $paymentData['channel'],
                'payment_id' => $paymentData['id'],
                'country_code' => $paymentData['authorization']['country_code'] ?? null,
                'customer_email' => $paymentData['customer']['email'],
                'shipping_address' => $paymentData['metadata']['shipping_address'] ?? null,
                'billing_address' => $paymentData['metadata']['billing_address'] ?? null,
                'firstname' => $paymentData['metadata']['firstname'] ?? null,
                'lastname' => $paymentData['metadata']['lastname'] ?? null,
