...
Route::get('/getBuyerProfile/{buyerId}', [BuyerProfileController::class, 'getBuyerProfile'])->middleware(('auth:sanctum')) ->name('getBuyerProfile');//api to get user profile
...
Route::get('/getRecentSales', [SellerProfileController::class, 'getRecentSales'])->middleware(('auth:sanctum')) ->name('getRecentSales');//recent sales
Route::get('/getAllSales', [SellerProfileController::class, 'getAllSales'])->middleware(('auth:sanctum')) ->name('getAllSales');//recent sales
Route::get('/getTopSellingProducts', [SellerProfileController::class, 'getTopSellingProducts'])->middleware(('auth:sanctum')) ->name('getTopSellingProducts');//get Total profit
...
Route::get('/getBalance', [SellerProfileController::class, 'getBalance'])->middleware('auth:sanctum')->name('getBalance');//profile update endpointupdate for 
Route::get('/getWithdrawals', [SellerProfileController::class, 'getWithdrawals'])->middleware('auth:sanctum')->name('getWithdrawals');//profile update endpointupdate for 
Route::get('/getWithdrawalDetails/{withdrawalId}', [SellerProfileController::class, 'getWithdrawalDetails'])->middleware('auth:sanctum')->name('getWithdrawalDetails');//profile update endpointupdate for 
//End Api routes for Buyer account
...
Route::get('/paymentCallback', [CartController::class, 'paymentCallback'])->name('paymentCallback');
Route::get('/paymentSuccess',  [CartController::class, 'paymentSuccess'])->name('paymentSuccess');
Route::post('/webhook/paystack', [CartController::class, "handleWebhook"]);
